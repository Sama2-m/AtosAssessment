...
public class validateMailIsMandatoryTest extends TestBase{
	...
	public Object[][] data() throws IOException, BiffException {
		...
		ExcelReader xl = new ExcelReader("Sheet1", "VerifyMailIsmandatoryTest");
	...
	@Description("verify that mail is mandatory field")
	public void VerifyMailIsmandatoryTest (String firstName, String lastName, String phone, String mail, String password, String accountType, String validationMsg, String fieldNameToBeValidated) throws InterruptedException {
