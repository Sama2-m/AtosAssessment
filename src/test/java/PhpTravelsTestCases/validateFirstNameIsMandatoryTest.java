...
public class validateFirstNameIsMandatoryTest extends TestBase{
	...
	public Object[][] data() throws IOException, BiffException {
		...
		ExcelReader xl = new ExcelReader("Sheet1", "ValidateFirstNameIsMandatoryTest");
	...
	@Description("validate that first name is mandatory field")
	public void ValidateFirstNameIsmandatoryTest (String firstName, String lastName, String phone, String mail, String password, String accountType, String validationMsg, String fieldNameToBeValidated) throws InterruptedException {
